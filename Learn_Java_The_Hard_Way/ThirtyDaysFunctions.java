...
public class ThirtyDaysFunctions
{
	...
	*/
	...
	/**
	* Returns the number of days in a given monrht.
	*
	* @author Graham Mitchell
	* @param month the month number (1-12)
	* @return 	the number of days in a non-leap year for that month, or 31 if month our of range.
	*/
